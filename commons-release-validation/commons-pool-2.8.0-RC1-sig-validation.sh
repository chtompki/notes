...
ARTIFACTS="commons-pool2-2.8.0-bin.tar.gz;commons-pool2-2.8.0-bin.zip;commons-pool2-2.8.0-javadoc.jar;commons-pool2-2.8.0-sources.jar;commons-pool2-2.8.0-src.tar.gz;commons-pool2-2.8.0-src.zip;commons-pool2-2.8.0-test-sources.jar;commons-pool2-2.8.0-tests.jar;commons-pool2-2.8.0.jar;commons-pool2-2.8.0.pom"
